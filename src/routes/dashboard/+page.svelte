<script lang="ts">
    ...
    onMount(() => {
        ...
        // Initialize midterm grades chart with server data
        const midtermCtx = document.getElementById('midtermChart') as HTMLCanvasElement;
        midtermChart = new Chart(midtermCtx, {
            type: 'doughnut',
            data: {
                labels: Object.keys(data.gradeDistribution.midterm),
                datasets: [{
                    data: Object.values(data.gradeDistribution.midterm),
                    backgroundColor: [
                        'rgba(75, 192, 192, 0.5)',
                        'rgba(54, 162, 235, 0.5)',
                        'rgba(255, 206, 86, 0.5)',
        ...
        // Initialize finals grades chart with server data
        const finalsCtx = document.getElementById('finalsChart') as HTMLCanvasElement;
        finalsChart = new Chart(finalsCtx, {
            type: 'doughnut',
            data: {
                labels: Object.keys(data.gradeDistribution.finals),
                datasets: [{
                    data: Object.values(data.gradeDistribution.finals),
                    backgroundColor: [
                        'rgba(75, 192, 192, 0.5)',
                        'rgba(54, 162, 235, 0.5)',
                        'rgba(255, 206, 86, 0.5)',
